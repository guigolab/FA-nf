...
# Perl packages
RUN cpanm Bio::SearchIO Bio::SearchIO::blastxml Bio::SeqIO Config::Simple Config::JSON DBI DBD::SQLite File::Basename Getopt::Long IO::Handle JSON Lingua::EN::Ngram List::Util
